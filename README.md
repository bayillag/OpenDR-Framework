...
*   [**Tokyo, Japan**](OpenDR-Framework/notebooks/01_case_study_japan.ipynb): 3D Digital Twin integration with Project PLATEAU CityGML.
*   [**East Africa**](OpenDR-Framework/notebooks/01_hydrology_ethiopia.ipynb): Transboundary flood and malaria early warning in the Baro-Akobo-Sobat Basin.
*   [**Regional Watch**](OpenDR-Framework/notebooks/02_wildfire_tactical_watch.ipynb): Tactical wildfire watch using 15-minute GOES-16 updates.
